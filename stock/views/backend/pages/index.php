...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?= base_url("assets/backend/images") ?>/icon/favicon.ico">
    ...
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/themify-icons.css">
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/metisMenu.css">
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/slicknav.min.css">
    <!-- amchart css -->
    <link rel="stylesheet" href="https://www.amcharts.com/lib/3/plugins/export/export.css" type="text/css" media="all" />
    <!-- others css -->
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/typography.css">
    <link rel="stylesheet" href="<?= base_url("assets/backend/css") ?>/default-css.css">
...
<body>
										...
										<div class="nofity-list">
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="<?= base_url("assets/backend/images") ?>/author/author-img1.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="<?= base_url("assets/backend/images") ?>/author/author-img2.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="<?= base_url("assets/backend/images") ?>/author/author-img3.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
											...
											<a href="#" class="notify-item">
												<div class="notify-thumb">
													<img src="<?= base_url("assets/backend/images") ?>/author/author-img4.jpg" alt="image">
												</div>
												<div class="notify-text">
													<p>Aglae Mayer</p>
                                ...
                                <div class="market-status-table mt-4">
                                    <div class="table-responsive">
                                        <table class="dbkit-table">
                                            ...
                                            <tr>
                                                <td class="mv-icon"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/icon1.png" alt="icon">
                                                </td>
                                                <td class="coin-name">Dashcoin</td>
                                                <td class="buy">30% <img src="<?= base_url("assets/backend/images") ?>/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="<?= base_url("assets/backend/images") ?>/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/trends-up-icon.png" alt="icon"></td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/icon2.png" alt="icon"></div>
                                                </td>
                                                <td class="coin-name">LiteCoin</td>
                                                <td class="buy">30% <img src="<?= base_url("assets/backend/images") ?>/icon/market-value/triangle-down.png" alt="icon"></td>
                                                <td class="sell">20% <img src="<?= base_url("assets/backend/images") ?>/icon/market-value/triangle-up.png" alt="icon"></td>
                                                <td class="trends"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/trends-down-icon.png" alt="icon"></td>
                                                <td class="attachments">$ 56746,857</td>
                                                <td class="stats-chart">
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/icon3.png" alt="icon"></div>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="mv-icon">
                                                    <div class="mv-icon"><img src="<?= base_url("assets/backend/images") ?>/icon/market-value/icon4.png" alt="icon"></div>
                                                </td>
                            ...
                            <div class="card-body">
                                ...
                                <div class="letest-news mt-5">
                                    <div class="single-post mb-xs-40 mb-sm-40">
                                        <div class="lts-thumb">
                                            <img src="<?= base_url("assets/backend/images") ?>/blog/post-thumb1.jpg" alt="post thumb">
                                        </div>
                                    ...
                                    <div class="single-post">
                                        <div class="lts-thumb">
                                            <img src="<?= base_url("assets/backend/images") ?>/blog/post-thumb2.jpg" alt="post thumb">
                                        </div>
                                        <div class="lts-content">
                                            <span>Admin Post</span>
                                            <h2><a href="blog.html">Sed ut perspiciatis unde omnis iste.</a></h2>
    ...
    <script src="<?= base_url("assets/backend/js") ?>/vendor/jquery-2.2.4.min.js"></script>
    <!-- bootstrap 4 js -->
    <script src="<?= base_url("assets/backend/js") ?>/popper.min.js"></script>
    <script src="<?= base_url("assets/backend/js") ?>/bootstrap.min.js"></script>
    <script src="<?= base_url("assets/backend/js") ?>/owl.carousel.min.js"></script>
    ...
    <script src="<?= base_url("assets/backend/js") ?>/jquery.slicknav.min.js"></script>
    ...
    <script src="<?= base_url("assets/backend/js") ?>/line-chart.js"></script>
    <!-- all pie chart -->
    <script src="<?= base_url("assets/backend/js") ?>/pie-chart.js"></script>
    <!-- others plugins -->
    <script src="<?= base_url("assets/backend/js") ?>/plugins.js"></script>
