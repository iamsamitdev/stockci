  ...
  <script src="<?php echo base_url(); ?>assets/frontend/vendor/glightbox/js/glightbox.min.js"></script>
  ...
  <script src="<?php echo base_url(); ?>assets/frontend/vendor/waypoints/noframework.waypoints.js"></script>
